<?php /* Smarty version Smarty-3.1.16, created on 2014-05-09 18:31:25
...
?>
            <tr>
                ...
                <?php if ($_smarty_tpl->tpl_vars['group']->value['id']!=1) {?>
                    <a href="/groups/roleedit/<?php echo $_smarty_tpl->tpl_vars['group']->value['id'];?>
">Edytuj </a>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['group']->value['id']!=1&&$_smarty_tpl->tpl_vars['group']->value['id']!=2) {?>
                    <a onclick="confirm('Czy na pewno chcesz usunąć tą grupę?')" href="/ri.class/Scripts/EditGroups.php?action=del&id=<?php echo $_smarty_tpl->tpl_vars['group']->value['id'];?>
">Usuń</a>           
                <?php }?>
                </td>
            </tr>
