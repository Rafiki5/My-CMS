<?php /* Smarty version Smarty-3.1.16, created on 2014-05-13 13:17:46
...
?>
                <?php if ($_smarty_tpl->tpl_vars['user']->value['id']==1&&$_smarty_tpl->tpl_vars['group']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]=='_superadministrator') {?><input type="hidden" name="role[]" value="_superadministrator"/><?php }?> 
                <input <?php if (in_array($_smarty_tpl->tpl_vars['group']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']],$_smarty_tpl->tpl_vars['user']->value['role'])) {?>checked=""<?php }?><?php if ($_smarty_tpl->tpl_vars['user']->value['id']==1&&$_smarty_tpl->tpl_vars['group']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]=='_superadministrator') {?>disabled=""<?php }?> type="checkbox" name="role[]" value="<?php echo $_smarty_tpl->tpl_vars['group']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']];?>
"/><?php echo $_smarty_tpl->tpl_vars['group']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']];?>
<br>
            <?php endfor; endif; ?>
            <?php }?>
